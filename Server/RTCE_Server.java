...
public class RTCE_Server {
     ...
     */
    private static String handleRequest(String userInput, RTCE_User curClient) throws UnsupportedEncodingException {
    ...
    /**
     * Helper method for the styleUpdate request. Changes the style of the current
     ...
     */
    private synchronized void updateUsers(int updateNum) {
     ...
     */
    private synchronized static void updateDocumentCounter(int num) {
